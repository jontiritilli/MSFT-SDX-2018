...
{
    public sealed class ListImage : Control
    {
        #region Constants
        ...
        private StorageFile bitmapFile;
        ...
        public ListImage()
        {
            this.DefaultStyleKey = typeof(ListImage);
        ...
        public static readonly DependencyProperty ImageSourceProperty =
            DependencyProperty.Register("ImageSource", typeof(string), typeof(ListImage), new PropertyMetadata(null, OnImageSourceChanged));
        ...
        public static readonly DependencyProperty ImageWidthProperty =
            DependencyProperty.Register("ImageWidth", typeof(double), typeof(ListImage), new PropertyMetadata(0d, OnImageWidthChanged));
        ...
        public static readonly DependencyProperty FadeInCompletedHandlerProperty =
            DependencyProperty.Register("FadeInCompletedHandler", typeof(EventHandler<object>), typeof(ListImage), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty FadeOutCompletedHandlerProperty =
            DependencyProperty.Register("FadeOutCompletedHandler", typeof(EventHandler<object>), typeof(ListImage), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty DurationInMillisecondsProperty =
            DependencyProperty.Register("DurationInMilliseconds", typeof(double), typeof(ListImage), new PropertyMetadata(2000d, OnDurationInMillisecondsChanged));
        ...
        public static readonly DependencyProperty StaggerDelayInMillisecondsProperty =
            DependencyProperty.Register("StaggerDelayInMilliseconds", typeof(double), typeof(ListImage), new PropertyMetadata(0d, OnDurationInMillisecondsChanged));
        ...
        DependencyProperty.Register("AutoStart", typeof(bool), typeof(ListImage), new PropertyMetadata(true, OnAutoStartChanged));
        ...
        private void RenderUI()
        {
            ...
            if (!String.IsNullOrWhiteSpace(this.ImageSource))
            {
                ...
                // UNCOMMENT when Config Services is added
                //else
                //{
                //    // get a reference to the file from local storage (IdleContent)
                //    bitmapFile = ConfigurationService.Current.GetFileFromLocalStorage(this.ImageSource);
        ...
        private async Task LoadBitmapFromFileAsync(BitmapImage bitmapImage, StorageFile imageFile)
        {
            ...
            await bitmapImage.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () =>
            {
