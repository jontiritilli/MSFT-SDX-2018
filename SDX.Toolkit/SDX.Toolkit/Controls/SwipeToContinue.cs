...
namespace SDX.Toolkit.Controls
{
    ...
    public sealed class SwipeToContinue : Control
    {
        ...
        public static readonly DependencyProperty SwipeTextProperty =
            DependencyProperty.Register("SwipeText", typeof(string), typeof(SwipeToContinue), new PropertyMetadata(null, OnSwipeTextChanged));
        ...
        public static readonly DependencyProperty DurationInMillisecondsProperty =
            DependencyProperty.Register("DurationInMilliseconds", typeof(double), typeof(SwipeToContinue), new PropertyMetadata(200d, OnDurationInMillisecondsChanged));
        ...
        public static readonly DependencyProperty StaggerDelayInMillisecondsProperty =
            DependencyProperty.Register("StaggerDelayInMilliseconds", typeof(double), typeof(SwipeToContinue), new PropertyMetadata(0d, OnStaggerDelayInMillisecondsChanged));
        ...
        DependencyProperty.Register("AutoStart", typeof(bool), typeof(SwipeToContinue), new PropertyMetadata(true, OnAutoStartChanged));
