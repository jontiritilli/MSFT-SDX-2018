...
{
    public sealed class AnimatablePercent : Control
    {
        ...
        public AnimatablePercent()
        {
            this.DefaultStyleKey = typeof(AnimatablePercent);
        ...
        public static readonly DependencyProperty PercentValueProperty =
            DependencyProperty.Register("PercentValue", typeof(double), typeof(AnimatablePercent), new PropertyMetadata(0.0, OnPercentValueChanged));
        ...
        public static readonly DependencyProperty PercentTextProperty =
            DependencyProperty.Register("PercentText", typeof(string), typeof(AnimatablePercent), new PropertyMetadata(0.0, OnPercentTextChanged));
        ...
        public static readonly DependencyProperty DurationInMillisecondsProperty =
            DependencyProperty.Register("DurationInMilliseconds", typeof(double), typeof(AnimatablePercent), new PropertyMetadata(2000d, OnDurationInMillisecondsChanged));
        ...
        public static readonly DependencyProperty StaggerDelayInMillisecondsProperty =
            DependencyProperty.Register("StaggerDelayInMilliseconds", typeof(double), typeof(AnimatablePercent), new PropertyMetadata(0d, OnStaggerDelayInMillisecondsChanged));
        ...
        DependencyProperty.Register("AutoStart", typeof(bool), typeof(AnimatablePercent), new PropertyMetadata(true, OnAutoStartChanged));
        ...
        {
            AnimatablePercent percent = (AnimatablePercent)d;

            if (null != percent)
            {
                percent.PercentText = String.Format("{0:P0}", percent.PercentValue);
            }
        }
        ...
        private void RenderUI()
        {
            ...
            StyleHelper.SetFontCharacteristics(_percent, ControlStyles.FastChargePercent);
            _percent.SetBinding(TextBlock.TextProperty,
                new Binding() { Source = this, Path = new PropertyPath("PercentText"), Mode = BindingMode.OneWay });

            // add it to the root
            _layoutRoot.Child = _percent;

            // set up animation
            _storyboardPercent = SetupAnimation(this, 0.0, 0.8, this.DurationInMilliseconds, this.StaggerDelayInMilliseconds);
        }

        private Storyboard SetupAnimation(AnimatablePercent percent, double start, double finish, double duration, double staggerDelay)
        {
            ...
            Storyboard.SetTargetProperty(storyboard, "PercentValue");
            //storyboard.SetValue(Storyboard.TargetPropertyProperty, "PercentValue");
