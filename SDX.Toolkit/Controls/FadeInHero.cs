...
{
    public sealed class FadeInHero : Control
    {
        ...
        public FadeInHero()
        {
            this.DefaultStyleKey = typeof(FadeInHero);
        ...
        public static readonly DependencyProperty WordsProperty =
            DependencyProperty.Register("Words", typeof(string), typeof(FadeInHero), new PropertyMetadata(null, OnWordsChanged));
        ...
        public static readonly DependencyProperty WordRowsProperty =
            DependencyProperty.Register("WordRows", typeof(int), typeof(FadeInHero), new PropertyMetadata(1, OnWordRowsChanged));
        ...
        public static readonly DependencyProperty DurationPerWordInMillisecondsProperty =
            DependencyProperty.Register("DurationPerWordInMilliseconds", typeof(double), typeof(FadeInHero), new PropertyMetadata(400d, OnDurationPerWordInMillisecondsChanged));
        ...
        public double DurationPerWordInMilliseconds
        {
            ...
            set
            {
                ...
                // save it
                SetValue(DurationPerWordInMillisecondsProperty, value);
            }
        }

        // StaggerDelayMilliseconds
        public static readonly DependencyProperty StaggerDelayMillisecondsProperty =
            DependencyProperty.Register("StaggerDelayMilliseconds", typeof(double), typeof(FadeInHero), new PropertyMetadata(0d, OnStaggerDelayMillisecondsChanged));
        ...
        public double StaggerDelayMilliseconds
        {
            ...
            set
            {
                ...
                // save it
                SetValue(StaggerDelayMillisecondsProperty, value);
            }
        }

        // AutoStart
        public static readonly DependencyProperty AutoStartProperty =
        DependencyProperty.Register("AutoStart", typeof(bool), typeof(FadeInHero), new PropertyMetadata(false, OnAutoStartChanged));
