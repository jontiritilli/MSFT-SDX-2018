...
namespace SurfaceProDemo.Views
{
    ...
    /// </summary>
    public sealed partial class ComparePagePopupBook : Page, INavigate
    {
        public RoutedEventHandler CloseButton_Clicked;

        #region Private Members

        private ComparePopupBookViewModel ViewModel
        {
            get { return DataContext as ComparePopupBookViewModel; }
        }
        ...
        public static ComparePagePopupBook Current { get; private set; }
