...
namespace SurfaceBook2Demo.ViewModels
{
    public class ComparePopupLaptopViewModel
    {
        ...
        private const string URI_PRIMARYIMAGE_13 = "ms-appx:///Assets/Comparison/comparisonLaptop_13.png";
        private const string URI_PRIMARYIMAGE_15 = "ms-appx:///Assets/Comparison/comparisonLaptop_15.png";
        ...
        public ComparePopupLaptopViewModel()
        {
            ...
            if (null != localizationService)
            {
                ...
                localizationService.LoadComparePopupLaptopViewModel(this);
            }
        }
