...
namespace SurfaceStudioDemo.Models
{
    public sealed class LanguageFile
    {
        ...
        public string EXPERIENCE_OVERVIEW_COPY = "Dive into brilliant colour, blazing graphics, faster performance, and intuitive controls that fuel your creativity and free your ideas to flow.";
        ...
        public string EXPERIENCE_DISPLAY_COPY = "The 28” PixelSense™ Display touchscreen with 13.5 million pixels of true-to-life colour perfectly captures your creativity, whether illustrating a book or designing a virtual world.";
        ...
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_THREE = "Bluebeam®";
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_FOUR = "Concepts";
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_FIVE = "Adobe® Photoshop®";
        ...
        public string ACCESSORIES_LEFT_POPLEFT_COPY = "Stay connected with amazing audio, exceptional call clarity, and built-in intelligence on the go and in the office.";
        ...
        public string ACCESSORIES_RIGHT_POPLEFT_COPY = "Pairs Seemlessly with your Surface using Wireless Bluetooth at a range of up to 15 meters and with battery power to last a full year.";
        ...
        public string COMPARE_DEVICE_FOUR_POP_BULLET_ONE_LEGAL = "**Colours available on selected models only; available colors may vary by store.";
        ...
        public static LanguageFile CreateDefault()
        {
            ...
            languageFile.EXPERIENCE_OVERVIEW_COPY = "Dive into brilliant colour, blazing graphics, faster performance, and intuitive controls that fuel your creativity and free your ideas to flow.";
            ...
            languageFile.EXPERIENCE_DISPLAY_COPY = "The 28” PixelSense™ Display touchscreen with 13.5 million pixels of true-to-life colour perfectly captures your creativity, whether illustrating a book or designing a virtual world.";
            ...
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_THREE = "Bluebeam®";
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_FOUR = "Concepts";
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_FIVE = "Adobe® Photoshop®";
            ...
            languageFile.ACCESSORIES_LEFT_POPLEFT_COPY = "Stay connected with amazing audio, exceptional call clarity, and built-in intelligence on the go and in the office.";
            ...
            languageFile.ACCESSORIES_RIGHT_POPLEFT_COPY = "Pairs Seemlessly with your Surface using Wireless Bluetooth at a range of up to 15 meters and with battery power to last a full year.";
            ...
            languageFile.COMPARE_DEVICE_FOUR_POP_BULLET_ONE_LEGAL = "**Colours available on selected models only; available colors may vary by store.";
