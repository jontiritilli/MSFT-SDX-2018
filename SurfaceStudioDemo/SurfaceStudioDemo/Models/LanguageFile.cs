...
namespace SurfaceStudioDemo.Models
{
    public sealed class LanguageFile
    {
        ...
        public string EXPERIENCE_CRAFTSMANSHIP_COPY = "A minimal footprint and exceptionally thin profile meet the demands of the creative process, whether using Surface Caprock upright like a PC or drawing on it like a drafting table.";
        public string EXPERIENCE_CRAFTSMANSHIP_POPLEFT_TITLE = "Zero Gravity Hinge";
        public string EXPERIENCE_CRAFTSMANSHIP_POPLEFT_COPY = "Tilt the display weightlessly up to 20 degrees with one hand.";
        public string EXPERIENCE_CRAFTSMANSHIP_POPRIGHT_TITLE = "Complete connectivity";
        public string EXPERIENCE_CRAFTSMANSHIP_POPRIGHT_COPY = "• USB-C port\n• 4 USB 3.0 ports\n• Full-size SD™ card reader(SDXC compatible)\n• 3.5 mm headset jack\n•1 Gigabit Ethernet port";
        ...
        public string EXPERIENCE_DISPLAY_POPBOTTOM_COPY = "Create in new ways with apps that seamlessly integrate Surface Dial* from Adobe®, Corel, Autodesk®, and more.";
        ...
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_ONE = "Adobe® Premiere Pro®";
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_TWO = "Autodesk® Maya®";
        public string EXPERIENCE_DISPLAY_POPTOP_BULLET_THREE = "Autodesk® SketchBook®";
        ...
        public string ACCESSORIES_LEFT_POPLEFT_TITLE = "Surface Joplin*";
        ...
        public string ACCESSORIES_RIGHT_COPY = "Designed for comfort and precision, Surface Caprock includes the tools you use most for bringing creativity and productivity together. ";
        public string ACCESSORIES_RIGHT_POPLEFT_TITLE = "Surface Ergonomic Keyboard";
        public string ACCESSORIES_RIGHT_POPLEFT_COPY = "Updated keytop geometry, split space bar, and naturally arched shape protect from wrist and hand strain, while improving typing form.";
        ...
        public static LanguageFile CreateDefault()
        {
            ...
            languageFile.EXPERIENCE_CRAFTSMANSHIP_COPY = "A minimal footprint and exceptionally thin profile meet the demands of the creative process, whether using Surface Caprock upright like a PC or drawing on it like a drafting table.";
            languageFile.EXPERIENCE_CRAFTSMANSHIP_POPLEFT_TITLE = "Zero Gravity Hinge";
            languageFile.EXPERIENCE_CRAFTSMANSHIP_POPLEFT_COPY = "Tilt the display weightlessly up to 20 degrees with one hand.";
            languageFile.EXPERIENCE_CRAFTSMANSHIP_POPRIGHT_TITLE = "Complete connectivity";
            languageFile.EXPERIENCE_CRAFTSMANSHIP_POPRIGHT_COPY = "• USB - C port\n• 4 USB 3.0 ports\n• Full - size SD™ card reader(SDXC compatible)\n• 3.5 mm headset jack\n•1 Gigabit Ethernet port";
            ...
            languageFile.EXPERIENCE_DISPLAY_POPBOTTOM_COPY = "Create in new ways with apps that seamlessly integrate Surface Dial* from Adobe®, Corel, Autodesk®, and more.";
            ...
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_ONE = "Adobe® Premiere Pro®";
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_TWO = "Autodesk® Maya®";
            languageFile.EXPERIENCE_DISPLAY_POPTOP_BULLET_THREE = "Autodesk® SketchBook®";
            ...
            languageFile.ACCESSORIES_LEFT_POPLEFT_TITLE = "Surface Joplin*";
            ...
            languageFile.ACCESSORIES_RIGHT_COPY = "Designed for comfort and precision, Surface Caprock includes the tools you use most for bringing creativity and productivity together. ";
            languageFile.ACCESSORIES_RIGHT_POPLEFT_TITLE = "Surface Ergonomic Keyboard";
            languageFile.ACCESSORIES_RIGHT_POPLEFT_COPY = "Updated keytop geometry, split space bar, and naturally arched shape protect from wrist and hand strain, while improving typing form.";
