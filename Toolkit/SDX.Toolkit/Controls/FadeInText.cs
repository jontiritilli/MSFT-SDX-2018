...
{
    public sealed class FadeInText : Control
    {
        ...
        public FadeInText()
        {
            this.DefaultStyleKey = typeof(FadeInText);
        ...
        public static readonly DependencyProperty DurationInMillisecondsProperty =
            DependencyProperty.Register("DurationInMilliseconds", typeof(double), typeof(FadeInText), new PropertyMetadata(200d, OnDurationInMillisecondsChanged));
        ...
        public static readonly DependencyProperty FadeInCompletedHandlerProperty =
            DependencyProperty.Register("FadeInCompletedHandler", typeof(EventHandler<object>), typeof(FadeInText), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty FadeOutCompletedHandlerProperty =
            DependencyProperty.Register("FadeOutCompletedHandler", typeof(EventHandler<object>), typeof(FadeInText), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty StaggerDelayInMillisecondsProperty =
            DependencyProperty.Register("StaggerDelayInMilliseconds", typeof(double), typeof(FadeInText), new PropertyMetadata(0d, OnStaggerDelayInMillisecondsChanged));
        ...
        DependencyProperty.Register("AutoStart", typeof(bool), typeof(FadeInText), new PropertyMetadata(true, OnAutoStartChanged));
