...
namespace SurfaceLaptopDemo.Models
{
    public class LanguageFile
    {
        ...
        public string EXPERIENCE_STYLE_POP_COPY = "Available exclusively at select retailers like this one.";
        public string EXPERIENCE_DESIGN_HEADLINE = "Clean, elegant design";
        public string EXPERIENCE_DESIGN_COPY = "Surface Foxburg elevates on-the-go style with the perfect blend of color, texture, subtle details, and clean lines. ";
        ...
        public string EXPERIENCE_DESIGN_POPTOP_COPY = "At just 0.57” thin Surface Foxburg is ready to go anywhere.";
        ...
        public string EXPERIENCE_ENJOYMORE_COPY = "Experience crisp, clear audio thanks to a brilliant edge-to-edge display and Omnisonic Speakers with radiant omnidirectional sound.";
        public string EXPERIENCE_POWERFUL_HEADLINE = "More power for your passions";
        public string EXPERIENCE_POWERFUL_COPY = "Working your side hustle? Just relaxing? Surface Foxburg delivers the performance, portability, and battery life to do what you want.";
        ...
        public string EXPERIENCE_POPBOTTOM_COPY = "Power through your day with up to 14.5 hours of battery life.*";
        public string EXPERIENCE_POPBOTTOM_LEGAL = "*Battery life varies significantly with usage and settings.";
        public string ACCESSORIES_INTERACTIVE_HEADLINE = "Made for touch";
        public string ACCESSORIES_INTERACTIVE_COPY = "Draw, write, and navigate naturally on a stunning interactive screen that responds to your touch.";
        ...
        public static LanguageFile CreateDefault()
        {
            ...
            languageFile.EXPERIENCE_STYLE_POP_COPY = "Available exclusively at select retailers like this one.";
            languageFile.EXPERIENCE_DESIGN_HEADLINE = "Clean, elegant design";
            languageFile.EXPERIENCE_DESIGN_COPY = "Surface Foxburg elevates on-the-go style with the perfect blend of color, texture, subtle details, and clean lines. ";
            ...
            languageFile.EXPERIENCE_DESIGN_POPTOP_COPY = "At just 0.57” thin Surface Foxburg is ready to go anywhere.";
            ...
            languageFile.EXPERIENCE_ENJOYMORE_COPY = "Experience crisp, clear audio thanks to a brilliant edge-to-edge display and Omnisonic Speakers with radiant omnidirectional sound.";
            languageFile.EXPERIENCE_POWERFUL_HEADLINE = "More power for your passions";
            languageFile.EXPERIENCE_POWERFUL_COPY = "Working your side hustle? Just relaxing? Surface Foxburg delivers the performance, portability, and battery life to do what you want.";
            ...
            languageFile.EXPERIENCE_POPBOTTOM_COPY = "Power through your day with up to 14.5 hours of battery life.*";
            languageFile.EXPERIENCE_POPBOTTOM_LEGAL = "*Battery life varies significantly with usage and settings.";
            languageFile.ACCESSORIES_INTERACTIVE_HEADLINE = "Made for touch";
            languageFile.ACCESSORIES_INTERACTIVE_COPY = "Draw, write, and navigate naturally on a stunning interactive screen that responds to your touch.";
